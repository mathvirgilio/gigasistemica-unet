...
#Folder paths
DATASET_DIR = "/mnt/data/matheusvirgilio/gigasistemica/datasets/giga_new/dataset_corner_without_negatives/"
...
# Description
NOTES = 'Gamma = 0, Dataset giga_new apenas com ateromas'
